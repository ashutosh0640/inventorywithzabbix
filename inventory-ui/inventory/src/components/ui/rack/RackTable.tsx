                  ...
                  <td className="px-6 py-2">
                    <div className="flex items-center">
                      <div>
                        ...
                        <p className=" text-gray-600">{rack.location.name}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-2">
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${utilizationPercentage > 80 ? 'bg-red-100 text-red-800' :
                      ...
                      <div className="w-24 bg-gray-200 rounded-full h-1.5">
                        <div
                          className={`h-1.5 rounded-full ${utilizationPercentage > 80 ? 'bg-red-500' :
